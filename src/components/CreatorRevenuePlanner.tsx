    ...
    <div id="creator-revenue-planner" className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          {/* Educational Clarity Box & Financial Planning Guide */}
          <div className="p-5 rounded-2xl border border-indigo-200 bg-gradient-to-br from-indigo-50/90 to-purple-50/90 space-y-4 shadow-sm">
            <div className="flex items-center gap-2 text-xs font-bold text-indigo-900">
              ...
              <span>On-Chain Creator Revenue Planning Guide</span>
            </div>
            <p className="text-xs text-indigo-800 leading-relaxed">
              This planner calculates your projected primary mint revenue and secondary market creator royalties across Ethereum and Solana. All actual earnings are settled directly into your connected blockchain wallet.
            </p>
            <div className="p-3 bg-white/80 rounded-xl border border-indigo-100 flex items-center justify-between font-mono">
              <span className="text-xs text-slate-500 font-sans">Execution Standard:</span>
              <span className="text-xs font-bold text-indigo-700">100% On-Chain Mainnet/Testnet</span>
            </div>
          </div>
        </div>
      </div>
